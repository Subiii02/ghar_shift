...
class ProfileLaborScreen extends StatefulWidget {
  const ProfileLaborScreen({super.key});

  @override
  _ProfileLaborScreenState createState() => _ProfileLaborScreenState();
}

class _ProfileLaborScreenState extends State<ProfileLaborScreen> {
  File? _profileImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Labor Profile', style: TextStyle(color: SlightGray)),
